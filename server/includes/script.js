      ...
      codebase = {
          ...
          registerHandlers:function(){
              ...
              $('#autoComplete').on('click','li',function(){
                  var id = $(this).attr('id');
                  window.location = '/codebase/edit.php?id='+id;
              });
              //Keyboard shortcuts
              key('esc', function(){ 
                $('.autocomplete').hide();
          ...
          save:function(){
			  ...
			  htmlEncode = escape(htmlEncode); 
                          ...
                          notes = escape(notes);  
			  //return;
              var params = 'title='+title+'&html='+htmlEncode+'&css='+css+'&js='+js+'&notes='+notes+'&options='+optId+'&flag='+flag+'&id='+codeId+'';
             // console.log(params)
