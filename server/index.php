    ...
    <body>
        ...
        <div class="header cf">
            ...
            <div class="buttons">
                         ...
                         <a href="dreamweaver-ext/codebase.mxp" class="btn" id="new">Download Extension</a>
                         
                         <a href="edit.php" class="btn new" id="new">Create new snippet</a>
                         
                         <a href="more.html" class="btn" id="new">More tools..</a>
